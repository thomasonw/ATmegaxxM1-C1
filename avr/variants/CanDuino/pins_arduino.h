...
#define digitalPinHasPWM(p)         ((p) == 1 || (p) == 4 || (p) == 3)
...
#define DAC_PORT    7                                          // ATmegaxxM1 has DAC on Port 10 (pin PC7).  Enable it with analogWrite()
...
const uint8_t PROGMEM analog_pin_to_channel_PGM[14] = {
        ...
        8,      // A1           D16             PD6             ADC3
        9,      // A2           D17             PB2             ADC5
        10,      // A3           D18             PC4             ADC8 / AMP1-
        6,      // A4           D19             PC5             ADC9 / AMP1+    
        7,     // A5           D20             PC6             ADC10
        4,      // A6           D21             PB5             ADC6 / AMP2-
        3,      // A7           D22             PB6             ADC7
        2,      // A8           D23             PB7             ADC4
